...
export default class Home extends Component {
  ...
  getUsers = async () => {
    ...
    let url =
      config.baseURL + `destination_list.php?user_id_post=${arrayData.user_id}`;
  ...
  Promotion = async () => {
    ...
    if (arrayData != null) {
      ...
      url = config.baseURL + `destination_list.php?user_id_post=`;
    }
    ...
    this.setState((prevState) => {
      ...
      if (
        prevState &&
        prevState.promotions_arr &&
        prevState.promotions_arr.length > 0 &&
  ...
  render() {
    ...
    return (
      <View style={{ backgroundColor: Colors.white, flex: 1 }}>
        ...
        <Header
          ...
          headerHeight={300}
          name={
            user.value == 1 ? Lang_chg.txt_explore[1] : Lang_chg.txt_explore[0]
          }
          ...
          <ScrollView style={{ marginTop: 10 }}>
            ...
            >
              <TouchableOpacity>
                ...
                >
                  {user.value == 1
                    ? Lang_chg.popolardes[1]
                    : Lang_chg.popolardes[0]}
                </Text>
              </TouchableOpacity>
            </View>
            <View>
    ...
    <TouchableOpacity
      ...
      <Text>Close</Text>
            ...
            >
              {user.value == 1
                ? Lang_chg.txt_type_of_trips[1]
                : Lang_chg.txt_type_of_trips[0]}
            </Text>
                ...
                return (
                  <View
                    style={{
                      ...
                      alignContent: "center",
                      backgroundColor:
                        item.no_of_boat > 0 ? Colors.white : Colors.gray,
                      margin: 15,
                      borderRadius: 22,
                      padding: 10,
                      shadowColor: "#000",
