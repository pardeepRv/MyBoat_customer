...
import { Text, View, SafeAreaView, StatusBar, StyleSheet, TouchableOpacity, ImageBackground, Image, TextInput,Keyboard, KeyboardAvoidingView } from 'react-native'
import { 
    Input,SocialIcon
...
export default class Forgot extends Component {
    ...
    render() {
        return (
            <TouchableOpacity  activeOpacity={1} onPress={()=>{keyboard.dismiss()}}  style={{ flex: 1, height: '100%', }}>
                ...
                <ImageBackground style={{ width: '100%', height: '100%', backgroundColor: Colors.black, }} imageStyle={styles.ImageBackground_Img} source={backgd}  >
                    ...
                    <KeyboardAvoidingView style={styles.main_login}>
