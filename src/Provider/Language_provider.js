...
class Language_provider {
  ...
  textmobile = ['Mobile', 'التليفون المحمول']
  textBirthday = ['Birthday', 'عيد الميلاد']
  //boat add=============
  //boat name=====
  ...
  no_equpments_found = ['No Equipments Found', 'لم يتم العثور على معدات']
  no_eqipments_selected = ['No Equipment Selected', 'لم يتم تحديد أي معدات']
  no_entertainment_found = ['No Entertainments Found ', 'لم يتم العثور على ترفيه']
  no_entertainment_selected = ['No Entertainment selected', 'لم يتم تحديد ترفيه']
  no_food_found = ['No Food Found ', 'لم يتم العثور على طعام']
  no_food_selevcetd = ['No Food Selected', 'لم يتم اختيار طعام']
  Sel_data = ['Selected Item price :', ' سعر السلعة المحدد ']
  //=========signup=======
  ...
  Choose_from_library_txt = ['Choose Trip Date', 'اختر تاريخ الرحلة']
  ...
  txt_discount = ["Discount Coupon", "كوبون الخصم"]
  ...
  text_Boat_size0 = ["Boat size ", "حجم القارب"]
  txt_Boat_brand = ["Boat brand", "ماركة القارب"]
  ...
  avilable_text = ['Available', 'متوفرة']
  notavailable_text = ['Not available', 'غير متوفر']
  text_Person = ['Person', 'شخص']
  // trip type Details .....
  advertisementtrip = ['Advertisment type:', 'نوع الإعلان:']
  Discounttrip = ['Discount :', 'خصم :']
  triptypetrip = ['Trip Type :', 'نوع الرحلة:']
  Destinationtrip = ['Destination :', 'المكان المقصود :']
  Boatplacetrip = ['Boat place :', 'مكان القارب:']
  Triptypeprice = ['Trip price :', 'سعر الرحلة:']
  extraperhourtrip = ['Extra per hour :', 'زيادة في الساعة:']
  noogguesttrip = ['Max number of guests :', 'أقصى عدد للضيوف:']
  noogguest = ['No.of guest', 'عدد الضيف']
  noogguesttriptour = [' Number of guests :', 'عدد الضيوف :']
  triphourstrip = ['Trip hours :', 'ساعات الرحلة:']
  equpmenttrip = ['Equipment :', 'ادوات :']
  entertainmenttrip = ['Entertainment:', 'وسائل الترفيه:']
  foodtrip = ['Food :', 'طعام:']
  Loactiontrip = ['Location', 'موقع']
  chatnowtrip = ['Chat Now', 'الدردشة الآن']
  txt_Cabin = ["Cabin", "الطائرة"]
  Proceedtrip = ['Proceed', 'تقدم']
  select7edtrip = ['Selected', 'المحدد']
  extrarequesttrip = ['Extra Request', 'طلب إضافي']
  extraHourtrip = ['Extra hours', 'ساعات إضافية']
  Bookdatetrip = [' Book Date : ', 'تاريخ الكتاب:']
  TripTimetrip = ['Trip Time :', 'وقت الرحلة :']
  Customername = ['Customer name :', 'اسم الزبون :']
  triphourcheckout = [' Trip Hour :', 'ساعة الرحلة:']
  extrahourcheckout = ['Extra hours :', 'ساعات اضافية:']
  tripdestinationcheckout = ['Trip destination :', 'وجهة الرحلة:']
  coupendiscountcheckout = ['Coupon discount :', 'خصم القسيمة:']
  toatalpricecheckout = ['Total price :', 'السعر الكلي :']
  Extrarequestcheckout = ['Extra requests :', 'طلبات اضافية:']
  advertismenttypecheckout = ['Advertisment type :', 'نوع الإعلان:']
  lets_see = ['Lets see', 'الذهاب للإعلان']
  Starting = ['Starting', 'ابتداء من']
  KD = ['KD', 'د.ك']
  Customer_Name = [' Customer Name :', 'اسم الزبون :']
  signup_text_via_agree = ['By sign up, you agree to our', ' بالتسجيل ، أنت توافق على']
  I_have_already_account = ['I have already account ?', 'لدي حساب بالفعل؟']
  On_Going_Notifications = ['On Going Notifications', 'اشعارات الرحلة']
  Day = ['days', 'أيام']
  Can_days = ['Cancellation Time :', 'وقت الإلغاء']
  Hours = ['hrs', 'ساعة']
  ...
  ShowResult=['Show Results','أظهر النتائج']
